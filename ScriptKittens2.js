...
function autoTrade() {
	if (autoCheck[3] != "false") {
	  if ( (game.getEffect("heatMax") - 250) > game.time.heat ) {
      game.timeTab.cfPanel.children[0].children[0].controller.doShatterAmt(game.timeTab.cfPanel.children[0].children[0].model, 50); 
